...
"""
Run this first ->
youtube-dl --skip-download --write-description https://www.youtube.com/channel/UCvCqctX7CR6Mtxj8yj52sBg/videos
"""
...
get_url = compile(r'http.+', flags=IGNORECASE)
    ...
    async with aiofiles.open(file_name, mode="r") as f:
        ...
        async for line in f:
            if 'http' in line and backlist_pattern.search(line) is None:
                print(f"{identity}. [{name}]({get_url.search(line).group(0)})")
                flag = False
        if flag:
