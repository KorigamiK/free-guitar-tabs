...
"""
Run this first ->
youtube-dl --skip-download --write-description https://www.youtube.com/channel/UCth0pz1bQjWFVoX422pMypQ/videos
"""
    ...
    async with aiofiles.open(file_name, mode="r") as f:
        ...
        async for line in f:
            if 'http' in line and backlist_pattern.search(line) is None:
                print(f"{identity}. [{name}]({tab_pattern.sub('', line.strip()).strip()})")
                flag = False
        if flag:
